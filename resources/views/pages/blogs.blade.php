                    ...
                    <div class="blog-post bg-white box-shadow-medium margin-30px-bottom wow animate__fadeIn">
                        <div class="d-flex flex-column flex-md-row align-items-center">
                            <div class="blog-post-image sm-margin-25px-bottom">
                                <a href="{{route('blogDetailPage')}}" title=""><img src="{{ asset('front/images/blog-img73.jpg') }}" alt="" /></a>
                            </div>
                            <div class="post-details padding-4-half-rem-lr md-padding-2-half-rem-lr sm-no-padding">
                                <a href="blog-masonry.html" class="alt-font text-small text-fast-blue font-weight-500 text-uppercase d-inline-block margin-15px-bottom sm-margin-10px-bottom">30 January 2020</a>
                                <a href="{{route('blogDetailPage')}}" class="alt-font font-weight-500 text-extra-large text-extra-dark-gray d-block margin-20px-bottom sm-margin-10px-bottom">Asia-North Europe rates sinking again as GRIs 'run out of steam</a>
                                <p class="margin-seventeen-bottom sm-margin-25px-bottom">Ocean carriers are giving back their recent Asia-North Europe FAK rate increases via heavy discounts for October shipments from China.</p>
                                <div class="alt-font text-extra-small text-uppercase d-flex align-items-center sm-margin-10px-bottom">
                                    ...
                                    <span>
                                        <span class="d-inline-block">By <a href="blog-masonry.html" class="text-extra-dark-gray">The Load Star</a></span>
